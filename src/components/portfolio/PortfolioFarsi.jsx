      ...
      <div className="portfolio-main">
        <Tabs>
          <TabList className="portfolio-tab-list" data-aos="fade-up">
            <Tab className="portfoiloFr">همه</Tab>
            <Tab className="portfoiloFr">وب سایت</Tab>
            <Tab className="portfoiloFr">اپلیکیشن</Tab>
            <Tab className="portfoiloFr">نرم افزارهای خاص</Tab>
            <Tab className="portfoiloFr">فروشگاه آنلاین</Tab>
