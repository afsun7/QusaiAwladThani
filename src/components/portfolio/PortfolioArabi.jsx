      ...
      <div className="portfolio-main">
        <Tabs>
          <TabList className="portfolio-tab-list" data-aos="fade-up" >
            <Tab className="portfolioArabi" >الجميع</Tab>
            <Tab className="portfolioArabi">موقع إلكتروني</Tab>
            <Tab className="portfolioArabi">طلب</Tab>
            <Tab className="portfolioArabi">برامج محددة</Tab>
            <Tab className="portfolioArabi">متجر على الانترنت</Tab>
          </TabList>
